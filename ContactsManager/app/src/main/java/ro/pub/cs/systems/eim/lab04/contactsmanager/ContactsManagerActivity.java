...
public class ContactsManagerActivity extends AppCompatActivity {
    ...
    Button saveButton;
    Button cancelButton;
    Button showHideAdditionalFields;
            ...
            switch(view.getId()) {
                case R.id.show_hide_additional_fields:
                    switch(additionalFieldsContainer.getVisibility()) {
                        case View.VISIBLE:
                            showHideAdditionalFields.setText(getResources()
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showHideAdditionalFields = (Button) findViewById(R.id.show_hide_additional_fields);
        showHideAdditionalFields.setOnClickListener(buttonClickListener);
